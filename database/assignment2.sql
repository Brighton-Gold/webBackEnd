...
--Create New Record for Tony Stark
INSERT INTO account (first_name, last_name, email, password)
VALUES ('Tony', 'Stark', 'tony@starkent.com', 'Iam1ronM@n');

--Modify account to admin type
UPDATE account SET account_type = 'Admin' WHERE email = 'tony@starkent.com';

--Delete Tony Stark
DELETE FROM account WHERE email = 'tony@starkent.com';


--Inner join to select make and model from inventory and classification for items in 'sport' category
SELECT inv_make, inv_model FROM inventory INNER JOIN classification ON inventory.classification_id = classification.classification_id WHERE classification.classification_name = 'Sport';

--Modify Hummer to have 'huge interior' in description
UPDATE inventory SET inv_description = 'Do you have 6 kids and like to go offroading? The Hummer gives you the huge interior with an engine to get you out of any muddy or rocky situation.' WHERE inv_make = 'GM' AND inv_model = 'Hummer';

--Update all records in inentory to add '/vehicles/' to the middle of the file path in the inv_image and inv_thumbnail columns
UPDATE inventory SET inv_image = CONCAT(SUBSTRING(inv_image, 1, 8), '/vehicles/', SUBSTRING(inv_image, 9)), inv_thumbnail = CONCAT(SUBSTRING(inv_thumbnail, 1, 8), '/vehicles/', SUBSTRING(inv_thumbnail, 9));